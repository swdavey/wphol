...
variable "mds_admin_user" {
  description = "MySQL Database Service admin user name."
  default = "admin"
}
...
variable "wp_schema_name" {
  description = "WordPress MySQL schema name."
  default     = "wordpress"
}
...
variable "wp_admin_email" {
  description = "Email address for the Wordpress administrator."
  default = ""
}
